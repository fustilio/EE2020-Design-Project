...
#Sch name = XA1_N
set_property PACKAGE_PIN K3 [get_ports {row[4]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {row[4]}]
#Sch name = XA2_N
set_property PACKAGE_PIN M3 [get_ports {row[5]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {row[5]}]
#Sch name = XA3_N
set_property PACKAGE_PIN M1 [get_ports {row[6]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {row[6]}]
#Sch name = XA4_N
set_property PACKAGE_PIN N1 [get_ports {row[7]}]				

...
HD_PWD='C:/Users/Francis/Desktop/EE2020_FINAL/EE2020_Design_Project/design_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AUDIO_FX_TOP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AUDIO_FX_TOP.tcl

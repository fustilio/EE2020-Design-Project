...
HD_PWD='C:/Users/Francis/Desktop/EE2020_FINAL/EE2020_Design_Project/design_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AUDIO_FX_TOP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AUDIO_FX_TOP.tcl -notrace
